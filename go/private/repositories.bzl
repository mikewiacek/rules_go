...
def go_rules_dependencies(force = False):
    ...
    wrapper(
        ...
        # v0.7.0, latest as of 2023-04-02
        urls = [
    ...
    wrapper(
        ...
        # v0.6.0, latest as of 2023-04-02
        urls = [
    ...
    wrapper(
        ...
        # v1.30.0, latest as of 2023-04-02
        urls = [
    ...
    wrapper(
        ...
        # v1.5.3, latest as of 2023-04-02
        urls = [
    ...
    wrapper(
        ...
        # v0.3.2, latest as of 2023-04-02
        urls = [
    ...
    wrapper(
        ...
        # v1.3.2, latest as of 2023-04-02
        urls = [
    ...
    wrapper(
        ...
        # main, as of 2023-04-02
        urls = [
            "https://mirror.bazel.build/github.com/googleapis/go-genproto/archive/dcfb400f0633028bb925288e6cd93e22e4946303.zip",
            "https://github.com/googleapis/go-genproto/archive/dcfb400f0633028bb925288e6cd93e22e4946303.zip",
        ],
        sha256 = "86557e685b7bb61ddbca649b823019c2fbc2f9229de0ac8dbcf0789bbe2bb444",
        strip_prefix = "go-genproto-dcfb400f0633028bb925288e6cd93e22e4946303",
        patches = [
    ...
    wrapper(
        ...
        # master, as of 2023-04-02
        urls = [
            "https://mirror.bazel.build/github.com/googleapis/googleapis/archive/4c3b682f501bb965d34c3d4fc3461edfccf962db.zip",
            "https://github.com/googleapis/googleapis/archive/4c3b682f501bb965d34c3d4fc3461edfccf962db.zip",
        ],
        sha256 = "8b69a72775f6ad778bb840beac8b41d10757da4a3c5b65ebb8225437891a8dfa",
        strip_prefix = "googleapis-4c3b682f501bb965d34c3d4fc3461edfccf962db",
        patches = [
    ...
    _maybe(
        ...
        # v1.7.0-rc.1, latest as of 2023-04-02
        urls = [
